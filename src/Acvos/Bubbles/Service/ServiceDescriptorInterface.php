...
use Acvos\Bubbles\DependentInterface;

/**
 * Service descriptor: descriptor with allowed dependencies
 *
 * @author Anton Chernikov <achernikov@acvos.com>
 */
interface ServiceDescriptorInterface extends DescriptorInterface, DependentInterface
{
}